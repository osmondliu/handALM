 ...
 */
require_once('modules/HIE_exp_apply_lines/HIE_exp_apply_lines_sugar.php');
class HIE_exp_apply_lines extends HIE_exp_apply_lines_sugar {
	...
	function get_list_view_data(){
		...
		if ($bean_product) {
			$fields['PRODUCT_NUMBER'] = $this->bean->product_number = isset($bean_product->part_number)?$bean_category->part_number:''; 
